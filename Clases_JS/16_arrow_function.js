...
const cadenaInvertida4 = (cadena) => {
  !cadena ? console.log("No has ingresado una cadena") : typeof cadena !== "string" ? console.log("No es una cadena") : console.log(cadena);
};
// cadenaInvertida4();
// cadenaInvertida4("hola");
// cadenaInvertida4(5);
